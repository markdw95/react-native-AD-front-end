let targetWordle = [
  ...
  [
    "Place to stay right after golf?",
    "hotel"
  ],
  [
    "House with rubbish container on drive",
    "bingo"
  ],
  [
    "Home help turned up in a state",
    "india"
  ],
  [
  ...
  [
    "Languages once spoken and not used — only internally",
    "norse"
  ],
  [
    "European whiskey is on board",
    "swiss"
  ],
  [
    "Finally put sword in mobile cover",
    "tepee"
  ],
  [
    "Sunflower’s head — healthy source of oil",
    "shale"
  ],
  [
    "Milling corn gerbils ate regularly",
    "grist"
  ],
  [
    "What’s initially sported by Islamic haji residing at Mecca?",
    "ihram"
  ],
  [
    "Keep quiet about your area’s grape variety",
    "syrah"
  ],
  [
    "Capitals in Africa built up just as Nigerian one",
    "abuja"
  ],
  [
    "Insect with wings clipped crawled around",
    "eggar"
  ],
  [
    "Thrash for one with large appetite",
    "whale"
  ],
  [
    "Could be represented as one term in yoga",
    "asana"
  ],
  [
