  ...
  const submitForm = async () => {
    ...
    try {
      ...
      const purchOrderData = {
        OrderVendorAccountNumber: purchOrderHeaderDetails.OrderVendorAccountNumber,
        PurchaseOrderNumber: purchOrderHeaderDetails.PurchaseOrderNumber,
...
<View style={{ flex: 1, paddingTop: 120 }}>
    ...
    <View style={{ height: 80 }}>
      <FormHeader
        leftHeading='Add line to purchase order'
      ...
      <FormInput
        ...
        autoCapitalize='none'
      />
      <FormSubmitButton onPress={submitForm} title='Add line to Purchase Order' />
